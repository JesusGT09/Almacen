...
$("#form_entrada").validate({ debug: true,
  rules:{
    fecha:{required: true},
  ...
  submitHandler: function(form){
    guardarForm("pages/entrada/crear_entrada.php", "form_entrada", function(resultado){
    if (resultado == "err:ok") {
        funcionajax("pages/entrada/new_entrada.php","contenido-main","");
        swal("Registro Exitoso!", "Entrada registrada con exito!", "success");
