              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <div class="product-img">
                      <img src="dist/img/default-50x50.gif" id="image" style="width: 100px;" alt="Product Image">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" id="precio" name="precio" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" id="stock" name="stock" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="">
                  </div>
                </div>
...
$("#form_producto").validate({ debug: true,
  rules:{
  ...
  submitHandler: function(form){
    guardarForm("pages/producto/crear_producto.php", "form_producto", function(resultado){
    if (resultado == "err:ok") {
        upload_image();
