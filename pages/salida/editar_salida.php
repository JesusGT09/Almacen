...
$resultado_cnsc = $obj_cnsc->ConsultarIdSalida($_POST["id"]);
...
<section class="content">
       <div class="row">
         <form id="form_editar_salida"  method="post">
           <div class="col-md-6">
               ...
               <div class="box-body">
                 ...
                 <div class="form-group">
                   ...
                   <div class="input-group">
                     ...
                     <input type="text" id="id" value="<?php echo $listado_p["id"]; ?>"   name="id" class="form-control" readonly autocomplete="off">
                   </div>
                 </div>
                 ...
                 <div class="form-group">
                   ...
                   <div class="input-group">
                     ...
                     <input type="text" id="fecha" value="<?php echo $listado_p["fecha"]; ?>"  name="fecha" class="form-control" readonly autocomplete="off">
                   </div>
                 </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group" style="display:none;">
                   ...
                   <div class="input-group">
                     ...
                     <input type="text" id="iduser" name="iduser"  value="<?php echo $_SESSION['codigo']; ?>" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="">
                   </div>
                 </div>
                 ...
                 <div class="form-group">
                   ...
                   <div class="input-group">
                     ...
                     <input type="number" id="cantidad" value="<?php echo $listado_p["cantidad"]; ?>"  name="cantidad" class="form-control" autocomplete="off">
                   </div>
                 </div>
...
$("#form_editar_salida").validate({ debug: true,
  rules:{
    id:{required: true},
    fecha:{required: true},
    tipo:{required: true},
  ...
  submitHandler: function(form){
    guardarForm("pages/salida/modificar_salida.php", "form_editar_salida", function(resultado){
    if (resultado == "err:ok") {
        swal("actualizacion Exitoso!", "Salida actualizada con exito!", "success");
