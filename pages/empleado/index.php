...
<section class="content">
  <div class="box">
    ...
    <div class="col-md-2">
      <button type="button" id="new_notificacion" class="btn btn-block btn-default"><i class="fa fa-tags" aria-hidden="true"></i> Nuevo Personal</button>
    </div>
    <table id="example1" class="table table-bordered table-striped">
      ...
      <tbody>
        <?php
          ...
          $resultado_cnsc = $obj_cnsc->ConsultarEmpleado();
               ...
               ?>
                 <tr class="dato">
                   ...
                   <td style="text-align:center;">
                     <div class="btn-group">
                       <button type="button" atrib="<?php echo $listar_repuesto["id"]; ?>" class="eliminar_usuario btn btn-danger">Eliminar</button>
                       <button type="button" atrib="<?php echo $listar_repuesto["id"]; ?>" class="editar_usuario btn btn-warning">Editar</button>
                     </div>
                   </td>
                 </tr>
                 <?php
...
$(".eliminar_usuario").click(function(){
  var a = $(this).attr("atrib");
   funcionajax("pages/empleado/eliminar_usuario.php","contenido-main",a);
});

$(".editar_usuario").click(function(){
  var a = $(this).attr("atrib");
  funcionajax("pages/empleado/editar_usuario.php","contenido-main",a);
});
